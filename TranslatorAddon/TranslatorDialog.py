...
class TranslatorDialog(QDialog):
    ...
    def createTranslContent(self):
        ...
        self.tableTranslations.horizontalHeader().setSectionResizeMode(QHeaderView.ResizeMode.Interactive)
    ...
    def keyPressEvent(self, QKeyEvent:QKeyEvent):
        if QKeyEvent.key() == Qt.Key.Key_Enter or QKeyEvent.key() == Qt.Key.Key_Return:
            return
